...
c.getPlayer().getClient().getSession().write(CField.getGameMessage("BOOP", false)); //pink
   ...
   public static class gms extends CommandExecute {
    ...
    public static class top30 extends CommandExecute {
      ...
      /*  public static class jaira extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            ...
            if (c.getPlayer().haveItem(4001168, 250)) {
                MapleInventoryManipulator.removeById(c, MapleInventoryType.ETC, 4001168, 250, false, false);

            final int mid = 9304005;
            final int num = 1;
            long newhp = 10000000000L;
            ...
            final OverrideMonsterStats overrideStats = new OverrideMonsterStats(newhp, onemob.getMobMaxMp(), 1, false);
            for (int i = 0; i < num; i++) {
                ...
                c.getPlayer().dropMessage(5, "Need 250 GML to spawn Jaira!");
            }
            return 1;
        }
    }
