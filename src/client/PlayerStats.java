    ...
    public void recalcLocalStats(boolean first_login, MapleCharacter chra) {
        ...
        switch (chra.getJob()) {
            ...
            case 422: {
                ...
                bx = SkillFactory.getSkill(4100006); //影之抵抗
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    percent_hp += eff.getPercentHP();
                ...
                bx = SkillFactory.getSkill(4200006); //影之抵抗
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    percent_hp += eff.getPercentHP();
            ...
            case 522: {
                ...
                bx = SkillFactory.getSkill(5110000);
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    passive_sharpeye_rate += eff.getCr();
                ...
                bx = SkillFactory.getSkill(5200007);
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    passive_sharpeye_rate += eff.getCr();
            ...
            case 1312: {
                defRange = 200;
                bx = SkillFactory.getSkill(13000000);
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    passive_sharpeye_rate += eff.getCr();
            ...
            case 1412: {
                defRange = 200;
                bx = SkillFactory.getSkill(14100001);
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    passive_sharpeye_rate += eff.getCr();
            ...
            case 2217:
            case 2218: {
                magic += chra.getTotalSkillLevel(SkillFactory.getSkill(22000000)); //龍之魂
            ...
            case 2312: {
                defRange = 200;
                bx = SkillFactory.getSkill(20020022);
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    passive_sharpeye_rate += eff.getCr();
            ...
            case 2412: {
                ...
                bx = SkillFactory.getSkill(24100006); //幸運富翁
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
            ...
            case 3112: {
                mpRecoverProp = 100;
                bx = SkillFactory.getSkill(30010022); //一擊
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    passive_sharpeye_rate += eff.getCr();
                ...
                bx = SkillFactory.getSkill(31100005); //體能訓練
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    localstr += eff.getStrX();
                ...
                bx = SkillFactory.getSkill(31100006); //憤怒
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    watk += eff.getAttackX();
                ...
                bx = SkillFactory.getSkill(31110009); //強化惡魔之力
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    mpRecover += 1;
                ...
                bx = SkillFactory.getSkill(31120009); //堅硬肌膚
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    percent_wdef += bx.getEffect(bof).getT();
                }
    ...
    */
    public void relocHeal(MapleCharacter chra) {
        ...
        if (playerjob == 111 || playerjob == 112) {
            ...
            final Skill effect = SkillFactory.getSkill(5100013); // Improving MP Recovery
