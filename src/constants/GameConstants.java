...
public class GameConstants {
    ...
    public static int getAttackDelay(int id, Skill skill) {
        switch (id) { // Assume it's faster(2)
            ...
            case 35121013: //合金盔甲: 重機槍
                return 40; //reason being you can spam with assaulter
            case 4121007:
            case 5221007:
            case 14111005:
    ...
    */
    ...
    public static boolean isNoDelaySkill(int skillId) {
        return skillId == 5110001 || skillId == 21101003 || skillId == 15100004 || skillId == 33101004 || skillId == 32121003 || skillId == 35121005 || skillId == 35111004 || skillId == 35121013 || skillId == 35121003 || skillId == 22150004 || skillId == 22181004 || skillId == 11101002 || skillId == 13101002 || skillId == 24121000 || skillId == 31121005;
    }
