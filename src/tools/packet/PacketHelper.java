    ...
    */
    public static final void addSkillInfo(final MaplePacketLittleEndianWriter mplew, final MapleCharacter chr) { // 0x100
        ...
        for (Entry<Skill, SkillEntry> skill : skills.entrySet()) {
            ...
            if (skill.getKey().getId() == 80000000 || skill.getKey().getId() == 80000001 || skill.getKey().getId() == 80000002 || skill.getKey().getId() == 80001040 || skill.getKey().getId() == 80001140) { //顯示傳授技能的角色
                mplew.writeInt(skill.getValue().teachId);
            } else if (skill.getKey().getId() == 110 || skill.getKey().getId() == 20021110 || skill.getKey().getId() == 20030204 || skill.getKey().getId() == 30010112 || skill.getKey().getId() == 50001214) { //過濾已傳授技能的角色
