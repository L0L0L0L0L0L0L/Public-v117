        ...
        if (ret.skill) { // hack because we can't get from the datafile...
            switch (sourceid) {
                ...
                case 5210012: //神槍手耐性
                    ...
                    ret.statups.put(MapleBuffStat.MDEF, ret.x);
                    ret.statups.put(MapleBuffStat.HP_BOOST, ret.x);
                    ret.statups.put(MapleBuffStat.MP_BOOST, ret.x);
                    break;
                case 5211006:
                    ret.duration = 2100000000;
                    ...
                    break;
                case 5211009:
                    ret.statups.put(MapleBuffStat.ENHANCED_WATK, ret.y);
                    break;
                case 5211011:
                    ret.duration = 2100000000;
                    ret.statups.put(MapleBuffStat.SUMMON, 1);
                ...
                case 5221009:
                    ...
                    break;
                case 5221018://海盜風采
                    ret.statups.put(MapleBuffStat.WATK, (int) ret.damR);
                    ...
                    //ret.statups.put(MapleBuffStat.AVOID, ret.eva);
                    break;
                case 5011002:
            ...
            case 5721009: // 海盜風采
                ...
                case 24111003://幸運卡牌守護
                    ret.statups.put(MapleBuffStat.MAXHP, ret.x);
                    ret.statups.put(MapleBuffStat.MAXMP, ret.x);
                    //ret.statups.put(MapleBuffStat.STATUS_RESIST, ret.x);
                    //ret.statups.put(MapleBuffStat.ABNORMAL_STATUS_R, ret.x);
                    //ret.statups.put(MapleBuffStat.ELEMENT_RESIST, ret.z);
                    break;
                case 24121004: //艾麗亞祝禱
                ...
                case 31121002: //吸血鬼之觸
                    ret.statups.put(MapleBuffStat.COMBO_DRAIN, ret.x);
                    //ret.statups.put(MapleBuffStat.吸血鬼之触, ret.x);
                    break;
                case 31121003: //魔力吶喊
                    ...
                    ret.monsterStatus.put(MonsterStatus.ACC, ret.x); //命中
                    break;
                case 31121004: //楓葉祝福
                    ret.statups.put(MapleBuffStat.MAPLE_WARRIOR, ret.x);
                    break;
...
//	final ScheduledFuture<?> schedule = TimerManager.getInstance().schedule(cancelAction, ((starttime + 99999) - System.currentTimeMillis()));
    ...
    */
    ...
    public final boolean isComboRecharge() {
        return skill && sourceid == 21111009; //鬥氣填充
    }
